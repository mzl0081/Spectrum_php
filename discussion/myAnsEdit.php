  ...
  <div id="contentArea">
    <div class="contentDivision" style="left: 0px; top: 0px;">
    	<p class="breadcrumb">
  		...
  		<h3><strong>Edit Answer</strong></h3>
  		  <form name="question_details" action="../data/db-ansEdit.php" method="POST">
          <center>
        <table style="width:700px; border="0">
          ...
          <tr>
            <td width="100" align="right">
              <strong>Update Answer:</strong>
            </td>
            <td width="245" align="left">
              <?php
              echo '<textarea name="ansDescription" rows="15" style="width:400px; text-transform:none;">';
              echo $ans;
              echo '</textarea>';
              ?>              
            </td>
