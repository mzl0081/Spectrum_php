        ...
        <table style="width:800px; border="0">
          ...
          if ($resultCheck > 0)
          {
            while($row = mysqli_fetch_assoc($result))
            {
              ...
              {
                $answererName = $findUser["userAccount"];
              }

              echo "<tr><td width='100' align='right'><strong>Answer ".$ansCount." : </strong><p>answer by ".$answererName."</p></td>";
          ...
          <tr>
            ...
            <td>
              ...
              <!-- <?php
              //$intervene = time() - $_SESSION["askQuesTime"];
              //if ( <= )


              ?> -->
              <input type="submit" name="editQues" value="Edit" onMouseOver="this.style.cursor='hand'" style="width:100px; height:30px;">
              <br><br>
            </td>
          </tr>
        </table>
