...
(function( factory ){
   ...
   $.extend( altEditor.prototype, {
       ...
       _editRowData: function()
       {
         ...
         if (data[1] != '' && data[2] != '' && data[2].match(emailFormat))
         {
           var message = '<div id="addAlert" class="alert alert-success" role="alert"></div>';
       ...
       _addRowData: function()
       {
        console.log('add row')
         ...
         if (data[0] != '' && data[1] != '' && data[2] != '' && data[3] != '' && data[2].match(emailFormat))
         {
           var message = '<div id="addAlert" class="alert alert-success" role="alert"></div>';
           $('#altEditor-modal .modal-body').append(message);
           dt.row.add(data[1]).draw(false);
         }
         //dt.row.add(data[1]).draw(false);
