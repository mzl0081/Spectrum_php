	...
	<div id="pageWrap"> 
  		<div id="headerWrap">
    		<div id="header">
      			...
      			<div id="headerTitle">
        			<div class="titleArea" style="position: relative;left: 230px;top:30px">
    	...
    	<div id="contentArea">
          <div class="sidebar"> <!-- TemplateBeginEditable name="sidebar" -->
            <h4><a class="upLink" href="./adminIndex.php">Introduction</a></h4><br />
            <div class="orangeDecorBar"></div>
            <a href="./studentInfo.php">User Information</a>
            <a href="./cases.php">Cases</a>
            <a href="./studentDisc.php">Discussions</a>
          </div>
    		<div class="contentDivision"> 
      			<p style="font-size:18px;position:relative;top :5px"> <!-- TemplateBeginEditable name="breadcrumb" --> Introduction <!-- TemplateEndEditable --> </p>
		...
		<div id="footerWrap">
    		<div id="footer"></div>  
    		<div id="subfooter">
      			Auburn University | Auburn, Alabama 36849 | (334) 844-4000  | <script type="text/javascript">emailE='auburn.edu'; emailE=('YourEmailAddress' + '@' + emailE); document.write("<a href='mailto:" + emailE + "'>" + emailE + "</a>");</script><br />
